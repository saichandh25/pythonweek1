...
#creating network
model = Sequential()
model.add(Dense(512, activation='tanh', input_shape=(dimData,)))#addedhidden layers by changing activation to tanh,sigmoid
model.add(Dense(512, activation='tanh'))                        #non linear activations are added
